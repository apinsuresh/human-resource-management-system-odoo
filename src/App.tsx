          ...
          <ul className="sidebar-nav-list">
            {session.role === 'ADMIN' ? (
              <>
                ...
                <li className={`sidebar-nav-item ${currentView === 'settings' && settingsTab === 'org_mgmt' ? 'active' : ''}`}>
                  <button 
                    type="button" 
                    onClick={() => {
                      setCurrentView('settings');
                      setSettingsTab('org_mgmt');
                      setMobileSidebarOpen(false);
                      setProfileDropdownOpen(false);
                    }}
                  >
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }} aria-hidden="true"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path></svg>
                    Organizations
                  </button>
                </li>
                <li className={`sidebar-nav-item ${currentView === 'settings' && settingsTab === 'user_mgmt' ? 'active' : ''}`}>
                  <button 
                    type="button" 
                    onClick={() => {
                      setCurrentView('settings');
                      setSettingsTab('user_mgmt');
                      setMobileSidebarOpen(false);
                      setProfileDropdownOpen(false);
                    }}
                  >
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }} aria-hidden="true"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                    Users
                  </button>
                </li>
                ...
                <li className={`sidebar-nav-item ${currentView === 'attendance_alias' ? 'active' : ''}`}>
                  <button 
                    type="button" 
                    onClick={() => {
                      // Redirect to main clock logs or keep current view to directory
                      setCurrentView('dashboard');
                      setMobileSidebarOpen(false);
                      setProfileDropdownOpen(false);
                    }}
                ...
                <li className={`sidebar-nav-item ${currentView === 'settings' && (!settingsTab || settingsTab === 'overview') ? 'active' : ''}`}>
                  <button 
                    type="button" 
                    onClick={() => {
                      setCurrentView('settings');
